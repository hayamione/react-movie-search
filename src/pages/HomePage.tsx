...
const HeroSkeleton = () => (
  <div
    className="animate-pulse rounded-2xl bg-slate-900 p-6 sm:p-8 lg:p-10"
    aria-hidden="true"
  >
    <div className="flex flex-col gap-6 lg:flex-row lg:items-end">
      <div className="aspect-[2/3] w-36 shrink-0 rounded-xl bg-slate-800 sm:w-44" />
  ...
  return (
    <section className="overflow-hidden rounded-2xl border border-slate-800 bg-slate-900">
      <div className="relative">
        ...
        <div className="relative flex flex-col gap-6 p-6 sm:p-8 lg:flex-row lg:items-end lg:p-10">
          <Poster
            src={movie.posterSrc}
            alt={movie.title}
            className="w-36 shrink-0 self-center sm:w-44 lg:self-auto"
          />
          <div className="flex flex-1 flex-col gap-3">
            ...
            <div className="flex flex-wrap items-center gap-3">
              {releaseYear && <span className="text-sm text-slate-400">{releaseYear}</span>}
            ...
            {movie.tagline && (
              <p className="text-sm italic text-slate-300">{movie.tagline}</p>
            )}
            {movie.overview && (
              <p className="line-clamp-3 max-w-2xl text-sm leading-relaxed text-slate-300">
                {movie.overview}
              </p>
            )}
      ...
      <div className="border-t border-slate-800 p-6 sm:p-8 lg:p-10">
